...
//
//            HuffmanEncoder ListOf_AABBB = new HuffmanEncoder();
//            List<Node> temp_list = ListOf_AABBB.HuffmanNodes(input);
//            HuffmanTree huffmanTreeOfAabbb = new HuffmanTree();
//            Node temp_tree = huffmanTreeOfAabbb.CreateTree(temp_list);
//
//            Dictionary<byte, UnevenByte> NodeDict = huffmanTreeOfAabbb.SetCode(temp_tree);
//            List<UnevenByte> NodeList = huffmanTreeOfAabbb.TreeMap(temp_tree);
//
...
//
//            UnevenByte temp = new UnevenByte((uint)ub.GetBits(8), 8);
//
...
//
//            UnevenByte subject = new UnevenByte((uint)test.GetBits(l), l);
//
